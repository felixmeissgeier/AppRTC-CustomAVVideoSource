...
#ifndef WEBRTC_API_OBJC_CUSTOMAVFOUNDATION_VIDEO_CAPTURER_H_
#define WEBRTC_API_OBJC_CUSTOMAVFOUNDATION_VIDEO_CAPTURER_H_
...
@class FrameInputAVFoundationVideoCapturerInternal;
...
class CustomVideoCapturer : public cricket::VideoCapturer,
 ...
 private:
  ...
  FrameInputAVFoundationVideoCapturerInternal *_capturer;
  rtc::Thread *_startThread;  // Set in Start(), unset in Stop().
};  // AVFoundationVideoCapturer

}  // namespace webrtc

#endif  // WEBRTC_API_OBJC_CUSTOMAVFOUNDATION_VIDEO_CAPTURER_H_
